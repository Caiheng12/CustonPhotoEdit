...
public final class CropImage {
    ...
    /**
     * The key used to pass crop image source URI to {@link CustomCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link CustomCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image bundle data to {@link CustomCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

    /**
     * The key used to pass crop image result data back from {@link CustomCropImageActivity}.
     */
    ...
    /**
     * The request code used to start {@link CustomCropImageActivity} to be used on result to identify the
     * this specific request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link CustomCropImageActivity}.
     */
     ...
     * CustomCropImageActivity} to crop the selected image.<br>
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link CustomCropImageActivity} to crop the given
     * image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be
     * retrieved using {@link #getActivityResult(Intent)}.
     *
    ...
    /**
     * Get {@link CustomCropImageActivity} result data object for crop image activity started using {@link
     * #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Get {@link CustomCropImageActivity} intent to start the activity.
         */
        public Intent getIntent(@NonNull Context context) {
            return getIntent(context, CustomCropImageActivity.class);
        }
        ...
        /**
         * Start {@link CustomCropImageActivity}.
         *
        ...
        /**
         * the title of the {@link CustomCropImageActivity}.<br>
         * <i>Default: ""</i>
         */
